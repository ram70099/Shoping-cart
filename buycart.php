...
<?php
	if(!empty($_GET['addtocart']))
	{
		...
		$uid=$_GET['uid'];
		$qty=$_GET['qty'];
		$query="insert into cart  (userid,productid,qunty) values($uid,$pid,$qty)";
		$query="update product set pstock=pstock-$qty where id=$pid";
		if(mysqli_query($connect,$query))
		{
			echo "Record inserted ";
			$query="UPDATE product set pstock where id ='$pid' ";
		}
		else{
						...
						<div class="machine-info">
							...
							<div class="quantity">
								<form>
									...
									<input type="hidden" name="uid" value="<?php if(!empty($_POST['userid'])){ echo $_SESSION['userid'];}?>"/>
									<table>
										<tr>
							...
							<div class="cart">
								<?php 
									...
									{
								?>
									<a href="index.php"><input type="button" value="First Login to  Buy"></a>
								<?php }else { ?>
							...
							<div class="checkout">
								<a href="shoping.php"><input type="button" name="" value="checkout"></a>
							</div>
						</div>
					</div>
					<div class="info">
